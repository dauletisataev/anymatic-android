...
public class AddProduct extends Fragment {
    ...
    private EditText name, price, owner, url;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        url = (EditText) v.findViewById(R.id.photo);
        ...
        addProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showProgressDialog();
                makePostProduct(name.getText().toString(), price.getText().toString(), url.getText().toString(), owner.getText().toString() );
            }
        });
        return v;
    }
    public  void makePostProduct(final String item_name, final String item_price, final String photoUrl, final String ownerName){

        Toast.makeText(getContext(), "Starting Creating...", Toast.LENGTH_SHORT).show();
        RequestQueue queue = Volley.newRequestQueue(getContext());
        final String Url = "http://anymatic.herokuapp.com/products";
